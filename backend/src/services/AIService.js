    ...
    7.When providing the final evaluation, respond with ONLY the raw JSON object. 
   No markdown, no code blocks, no explanatory text. Start your response with { and end with }.
